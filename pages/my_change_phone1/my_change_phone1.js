// pages/my_change_phone1/my_change_phone1.js
...
Page({
  ...
  onLoad: function (options) {
    var tel = options.tel;
    var tel2 = tel.substr(0, 3) + "****" + tel.substr(7);
    this.setData({
      tel1: tel,
      tel: tel2,
    })
        ...
        common.common_ajax(app.globalData.base_host + '?c=Tracingsource&a=VerificationNewMobile', param1, true, function (data) {
          ...
          if (data.result == 'success') {
            setTimeout(function () {
              ...
              wx.navigateTo({
                url: '/pages/my_change_phone2/my_change_phone2'
              })
